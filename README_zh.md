...
> 💡 **提示：** 点击 [swedish_dataset_list](./swedish_dataset_list.csv) 可查看完整列表。
...
# 读取数据集
url = "[https://raw.githubusercontent.com/您的用户名/仓库名/main/swedish_dataset_list.csv](https://raw.githubusercontent.com/您的用户名/仓库名/main/swedish_dataset_list.csv)"
df = pd.read_csv(url)
